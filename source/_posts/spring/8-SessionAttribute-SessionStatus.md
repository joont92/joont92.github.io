...
![세션을 이용한 폼 모델 저장/복구 (출처 : 토비의 스프링 vol2)](https://cloud2.zoolz.com/MyComputers/Images/Image.aspx?q=bT00MDcyNDcma2V5PTE5Mjg4MDk2NTkmdHlwZT1sJno9MjAxOC8wMy8wNyAyMzo0OA==)  
...
이럴바에는 처음부터 아예 모델을 사용하게 하고, 등록폼에는 빈 오브젝트라도 출력을 시켜주는 편이 낫다.  
